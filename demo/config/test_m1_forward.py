# ===========================================================================
# M1 — Forward Baseline — SMOKE TEST (50 iterations only)
# ===========================================================================
# Purpose: Verify the pipeline works end-to-end before committing to full training.
...
# Check that: loss is printed, eval runs, no CUDA errors.
# ===========================================================================
...
# Very short run — smoke test only
max_iters = 50
eval_interval = 25
eval_iters = 10
log_interval = 5
